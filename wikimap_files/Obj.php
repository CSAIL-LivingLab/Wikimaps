function WikiObj() {
	...
	this.openMarkerInfo = function (curNonce) {
		...
		divOutput += "<div class='popup' style='position:absolute;top:0px;left:0px;width:200px;height:160px;' id='defaultPopup"+curNonce+"' name='defaultPopup"+curNonce+"'" + "<table style='width:190px;font-size:8pt;' class='popup' border='0'>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='2'>";
		divOutput += "<div id='itemName"+curNonce+"'>"+curNonceInfo['name']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='2'>";
		divOutput += "<div id='itemLocation"+curNonce+"'>"+curNonceInfo['location']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='2'>";
		divOutput += "<div style='height:20px' id='itemCategory"+curNonce+"'>"+curNonceInfo['category']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='left' colspan='2'>";
		divOutput += "<div style='height:110px' id='itemDescription"+curNonce+"'>"+curNonceInfo['description']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td>";
		divOutput += "<a href='#' onClick='javascript:requestDeletion(\""+curNonce+"\")'>Suggest as incorrect or inappropriate<\/a>";
		divOutput += "<\/td>";
		divOutput += "<td>";
		divOutput += "<input type='button' class='box3' onclick='javascript:editData(\""+curNonce+"\")' value='Edit' />";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "</table><\/div>";
		divOutput += "<div class='popup' style='display:none;position:absolute;top:0px;left:0px;width:200px;height:160px;' id='editPopup"+curNonce+"' name='editPopup"+curNonce+"' onkeyup='updateEdit(\""+curNonce+"\")' onmouseup='updateEdit(\""+curNonce+"\")'" + "<table style='width:190px;font-size:8pt;' class='popup' border='0'>";
		divOutput += "<tr>";
		divOutput += "<td>";
		divOutput += "Item Name";
		divOutput += "<\/td>";
		divOutput += "<td>";
		divOutput += "<input type='text' maxlength='40' style='font-size:8pt;width:125px' id='itemNameE"+curNonce+"' value='"+curNonceInfo['nameE']+"' />";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td>";
		...
		divOutput += "<\/td>";
		divOutput += "<td>";
		divOutput += "<div id='itemLocationE"+curNonce+"'>"+curNonceInfo['locationE']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td>";
		...
		divOutput += "<\/td>";
		divOutput += "<td>";
		divOutput += "<select style='width:125px;font-size:8pt' id='itemCategoryE"+curNonce+"' /><option value='Bike Racks' \>Bike Racks<option value='Interesting Architecture' \>Interesting Architecture<option value='Paintings' \>Paintings<option value='Quick Food' \>Quick Food<option value='Sculptures' \>Sculptures<option value='Other' \>--Other--<\/select>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td colspan='2'>";
		divOutput += "Description:";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td colspan='2'>";
		divOutput += "<textarea id='itemDescriptionE"+curNonce+"' wrap='hard' style='width:184px;height:60px;font-size:8pt;font-family: Arial, Helvetica, sans-serif;'>"+curNonceInfo['descriptionE']+"<\/textarea>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td>";
		divOutput += "<a href='#' onClick='javascript:showInitPopup(\""+curNonce+"\")'>Back to location matches<\/a>";
		divOutput += "<\/td>";
		divOutput += "<td align='right'>";
		divOutput += "<input type='button' class='box3' onclick='javascript:addData(\""+curNonce+"\",\""+curNonceInfo['target'].point+"\");' value='Save' /><br /><input id='cancelEdit"+curNonce+"' type='button' class='box3' onclick='javascript:cancelEdit(\""+curNonce+"\")' value='Cancel' />";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "</table><\/div>";
