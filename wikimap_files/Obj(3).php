function PeopleObj() {
	...
	this.openMarkerInfo = function (curNonce) {
		...
		divOutput += "<div id='firstName"+curNonce+"'>"+curNonceInfo['firstname']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<td align='center'>";
		divOutput += "<div id='middleName"+curNonce+"'>"+curNonceInfo['middlename']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<td align='left'>";
		divOutput += "<div id='lastName"+curNonce+"'>"+curNonceInfo['lastname']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='3'>";
		divOutput += "<div id='personLocation"+curNonce+"'>"+curNonceInfo['location']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='3'>";
		divOutput += "<div id='personEmail"+curNonce+"'>"+curNonceInfo['email']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "</table><\/div>";
