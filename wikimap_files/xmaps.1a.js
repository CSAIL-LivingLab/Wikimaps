...
Array.prototype.Xconcat = function(arr) {
...
function XIcon(shapeName, style) {
    ...
    var outlineSrc = "http://mt.google.com/mld?width=" + width +
    ...
    var fillSrc = "http://mt.google.com/mld?width=" + width +
            "&height=" + height + "&path=" + shape.fillPath + "&color=" + color.red +
            "," + color.green + "," + color.blue + "," + alpha + "&weight=" + 1;

    var transparentSrc = "http://mt.google.com/mld?width=" + width +
    ...
    if (shape.shadowPath) {
        ...
        alpha = (1 - 0.25) * 255;
        shadowSrc = "http://mt.google.com/mld?width=" + (width * 2) +
...
XArrow.get = function(angle, color, opacity, size, weight) {
    ...
    var src = "http://mt.google.com/mld?width=" + width +
