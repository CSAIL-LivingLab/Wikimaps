function SchedObj() {
	...
	this.openMarkerInfo = function (curNonce) {
		...
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='3'>";
		divOutput += "<div id='itemName"+curNonce+"'>"+curNonceInfo['subject']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='3'>";
		...
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='3'>";
		divOutput += "<div id='itemDays"+curNonce+"'>"+curNonceInfo['days']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='right'>";
		divOutput += "<div id='itemStarttime"+curNonce+"'>"+curNonceInfo['starttime']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<td align='center'>";
		divOutput += "to";
		divOutput += "<\/td>";
		divOutput += "<td align='left'>";
		divOutput += "<div id='itemEndtime"+curNonce+"'>"+curNonceInfo['endtime']+"<\/div>";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "<tr>";
		divOutput += "<td align='center' colspan='3'>";
		divOutput += "This is Emilys class";
		divOutput += "<\/td>";
		divOutput += "<\/tr>";
		divOutput += "</table><\/div>";
